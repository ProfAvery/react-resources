...
To reproduce the bootrap process, use the following settings:

```console
$ npx create-next-app@latest code-cafe
...
$ echo "legacy-peer-deps=true" | tee -a .npmrc

$ npx create-airbnb-x-config
√ Config type? ... Legacy / (Extended)
